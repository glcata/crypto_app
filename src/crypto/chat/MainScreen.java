...
public class MainScreen extends javax.swing.JFrame implements WritableGUI {
     ...
     */
    public MainScreen() {
        client = JOptionPane.showInputDialog("Client Name ?");
        client += " : ";
        initComponents();
    }
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        if (message.getText() != null && !message.getText().isEmpty()) {
            MessageTransmitter transmitter = new MessageTransmitter(client + message.getText(), ipTextField.getText(), Integer.parseInt(targetPort.getText()));
            transmitter.start();
            write(client + message.getText());
